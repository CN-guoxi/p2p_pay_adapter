...
import com.qd.p2p.baofoo.param.BaofooBankCardListForEnterpriseParam;
import com.qd.p2p.baofoo.util.CommonUtil;

public class GetBankCardListForEnterpriseXmlDataParser extends AbstarctXmlDataParser {

	@Override
	public Class<? extends IRequestParam> supportsRequestParam() {
		return BaofooBankCardListForEnterpriseParam.class;
	}

	@Override
	public String parseRequest(IRequestParam param) throws RequestHandlerException {
		BaofooBankCardListForEnterpriseParam bankCardListParam = (BaofooBankCardListForEnterpriseParam)param;
