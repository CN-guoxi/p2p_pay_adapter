...
@Adapted(value = AdaptePlatform.BAOFOO, adaptedClass = QueryOrderStatusParam.class)
public class BFQueryOrderStatusParam extends AbstractRequestParam implements ParameterAdapter<QueryOrderStatusParam> {
    ...
    @Override
    public void adapter(QueryOrderStatusParam t) {
