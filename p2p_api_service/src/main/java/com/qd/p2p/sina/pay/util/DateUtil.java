...
public class DateUtil {
	...
	public static Date getTodayFirstIntegralTime() {
		Calendar cal = Calendar.getInstance();
	...
	public static Date getTodayLastIntegralTime() {
		Calendar cal = Calendar.getInstance();
	...
	public static Date getFirstSecIntegralTime(Date d) {
		...
		cal.set(Calendar.MINUTE, 0);
		cal.set(Calendar.MILLISECOND, 0);
		//cal.set(Calendar.DATE, 0);// Fix Bug
		return cal.getTime();
	}
	 ...
	 * @return
	 */
	public static Date rollDayStart(Date d, int day) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(d);
		cal.add(Calendar.DAY_OF_MONTH, day);
		cal.set(Calendar.HOUR_OF_DAY, 0);
